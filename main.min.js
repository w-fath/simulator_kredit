...
(window._gsQueue || (window._gsQueue = [])).push(function() {
    _gsDefine("plugins.ScrollToPlugin", ["plugins.TweenPlugin"], function(a) {
        ...
        c._onInitTween = function(a, b, c) {
            return this._wdw = a === e,
            this._target = a,
            this._tween = c,
            "object" != typeof b && (b = {
                y: b
            }),
            this._autoKill = b.autoKill !== !1,
            this.x = this.xPrev = this.getX(),
            this.y = this.yPrev = this.getY(),
            null != b.x ? this._addTween(this, "x", this.x, "max" === b.x ? f(a, "x") : b.x, "scrollTo_x", !0) : this.skipX = !0,
            null != b.y ? this._addTween(this, "y", this.y, "max" === b.y ? f(a, "y") : b.y, "scrollTo_y", !0) : this.skipY = !0,
            !0
        }
        ,
        c.getX = function() {
        ...
        ,
        c._kill = function(b) {
            return b.scrollTo_x && (this.skipX = !0),
            b.scrollTo_y && (this.skipY = !0),
            a.prototype._kill.call(this, b)
        }
        ,
        c.setRatio = function(a) {
            ...
            var b = this._wdw || !this.skipX ? this.getX() : this.xPrev
              ...
              , d = c - this.yPrev
              , f = b - this.xPrev;
            this._autoKill && (!this.skipX && (f > 7 || -7 > f) && (this.skipX = !0),
            !this.skipY && (d > 7 || -7 > d) && (this.skipY = !0),
            this.skipX && this.skipY && this._tween.kill()),
            this._wdw ? e.scrollTo(this.skipX ? b : this.x, this.skipY ? c : this.y) : (this.skipY || (this._target.scrollTop = this.y),
...
$.fn.formatAmount = function(e) {
    ...
    elem.on('keyup', function() {
        ...
        for (i = decimal_length; 0 < i; i--) {
            number += 1;
            decimal_result = 1 == number % 3 && 1 != number ? decimal_clean.substr(i - 1, 1) + "." + decimal_result : decimal_clean.substr(i - 1, 1) + decimal_result;
        }
...
$.fn.placeHolder = function() {
    var elem = this, data = elem.attr('data-placeholder'), _this;
...
$.fn.responsiveImage = function(s) {
    ...
    e = $.extend(e, s);
    var elem = this, etype, action = function() {
        if (e.type == undefined) {
            etype = "background";
        } else {
            etype = e.type;
...
function sliderHome() {
    ...
    elem.on('beforeChange', function(slick, direction, currentSlide) {//        animCaption("in");
    // animBg("in");
    });
    elem.on('afterChange', function(event, slick, currentSlide) {//        animCaption("out");
    // animBg("out");
    });
}
...
function animCaption(type) {
    ...
    if (type === "in") {// TweenLite.to([caps.find('h1'), caps.find('p'), caps.find('a'), caps.find('.dotted'), caps.find('.tabs')], 0.4, {css: {'left': '-50px','opacity': '0',},ease: Quart.easeOut});
    // console.log("as");
    } else {
